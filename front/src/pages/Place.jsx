      ...
      <div className="mx-auto flex max-w-7xl flex-col gap-4 p-4 sm:gap-6 sm:p-8">
        ...
        <div className="relative grid aspect-square gap-4 overflow-hidden rounded-2xl sm:aspect-3/2 sm:grid-cols-[2fr_1fr] sm:grid-rows-2">
          {place.photos
            ...
            .map((photo, index) => (
              <img
                className={`${index === 0 ? "row-span-2 h-full " : ""} aspect-square w-full cursor-pointer object-cover transition hover:opacity-80`}
                src={photo}
                alt=""
                key={photo}
        ...
        >
          ...
          <button
            className="absolute top-4 right-4 aspect-square w-8 cursor-pointer rounded-full bg-white font-bold transition hover:scale-105"
